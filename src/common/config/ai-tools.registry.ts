...
export const AI_TOOLS_REGISTRY: AiToolConfig[] = [
    {
        ...
        baseTokenCost: 1,
        accepts: ['text', 'photo', 'document', 'video', 'voice', 'audio'],
        isAsync: false,
    ...
    },
    {
        ...
        isAsync: true,
        instruction:
            'Flux 2 Pro: генерация и редактирование по промпту (до 8 референсов). ' +
            'Одно фото без текста — улучшение резкости. Два фото (исходник + маска) — удаление объекта. ' +
            'Человек + одежда — virtual try-on. В параметрах можно расширить кадр (outpaint).',
    },
    {
    ...
    },
    {
        ...
        isAsync: true,
        instruction:
            'Опишите сцену. Для оживления фото загрузите изображение; для эффектов — изображение обязательно.',
    },
    {
        id: AiToolId.HEYGEN,
        label: 'HeyGen',
