...
• можно выбрать качество: ниже / среднее / выше
...
• «Качество: лучше» — дольше, но аккуратнее выполняет сложный запрос
• «Качество: быстрее» — обычный быстрый режим
• «Поиск: да» — может подсмотреть свежие факты в сети (погода, новости, логотипы)
...
4. При желании включи «Качество: лучше» или «Поиск: да».
5. Запусти генерацию.`,
...
• 8 сек — 1 200
• 12 сек — 1 800
• «Высокое» качество дороже в 1.5 раза
...
• STD — обычное качество, PRO — лучше и дороже
...
3. Выбери формат, длительность, STD/PRO и звук.
4. Запусти генерацию.`,
...
• качество: обычное / чётче / очень чёткое
